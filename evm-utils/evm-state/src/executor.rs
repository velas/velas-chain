...
// TODO(L): Explain how these binaries were produced
pub const HELLO_WORLD_CODE: &str = include_str!("../tests/binaries/hello_world_code.hex");
pub const HELLO_WORLD_ABI: &str = "942ae0a7";
pub const HELLO_WORLD_RESULT: &str = include_str!("../tests/binaries/hello_world_result.hex");
pub const HELLO_WORLD_CODE_SAVED: &str =
    include_str!("../tests/binaries/hello_world_code_saved.hex");
