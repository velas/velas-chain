...
//     fn accounts(&self,
//         meta: Self::Metadata,
//     ) -> Result<Vec<Hex<Address>>, Error>;

//     #[rpc(meta, name = "eth_blockNumber")]
//     fn block_number(&self,
//         meta: Self::Metadata,
//     ) -> Result<Hex<usize>, Error>;
...
//         meta: Self::Metadata,
//         block: String, tx_id: Hex<U256>
//     ) -> Result<Option<RPCTransaction>, Error>;
    
//     #[rpc(meta, name = "eth_getTransactionReceipt")]
//     fn transaction_receipt(&self,
//         meta: Self::Metadata,
//         tx_hash: Hex<H256>
